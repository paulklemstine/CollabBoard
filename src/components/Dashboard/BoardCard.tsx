      ...
      >
        ...
        <div className="relative">
          ...
          <button
            ...
            className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 p-1.5 rounded-lg bg-white/80 backdrop-blur-sm text-gray-500 hover:text-violet-600 hover:bg-white shadow-sm transition-all duration-200"
          ...
          <div className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/50 to-transparent px-3.5 pb-2.5 pt-8">
            <h3 className="text-lg font-bold text-orange-300 truncate drop-shadow-sm">{board.name}</h3>
          </div>
        </div>
