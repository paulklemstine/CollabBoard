  ...
  return (
    ...
    >
      ...
      <div className="flex items-stretch">
        ...
        >
          <div className="flex items-center gap-1.5">
            <div className="flex flex-col items-center gap-0.5">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={connectMode ? 'currentColor' : connectorStyle.color} strokeWidth="2" strokeLinecap="round">
              ...
              {!connectMode && (
                <div
                  ...
                  style={{ width: 14, height: 3, backgroundColor: connectorStyle.color, minHeight: 3 }}
                />
              )}
            </div>
            {connectLabel}
        ...
        <button
          data-tutorial-id="connector-options"
